...
with the choice of $\Gamma = {\Sigma_{\varepsilon \varepsilon}}^{-1}$, minimizes simultaneously all the eigenvalues of ${\Sigma_{\varepsilon \varepsilon}}^{-1}W$ and hence minimizes $|W|$ (Robinson, 1974). 

## Estimation

So, $\hat{A}_r$ and $\hat{B}_r$ are ML estimates for $A$ and $B$. 
...
$$
\hat{\Sigma_{\varepsilon \varepsilon}} = (1/T) (Y - C_r X) {(Y - C_r X)}^T
$$
